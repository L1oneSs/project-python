...
| Удобство просмотра результата в Git | Высокое: HTML виден в ветке | Ниже: результат хранится как artifact/deployment |
| Рекомендуемый вариант для нового проекта | Допустимый альтернативный | Основной вариант |
